...
function getInputObject(i) {
    ...
    inputMinute.setAttribute("type", "date");
    inputMinute.setAttribute("min","2020-06-15")
    ...
    inputMinute.addEventListener('keydown', (e) => {
        if (e.which == 13) {
            if (e.currentTarget.value != "") {
                ...
                var countDownDate = document.querySelector('input[type="date"]');
                var miliseconds = new Date(countDownDate.value).getTime();
                ...
                var x = setInterval(function () {
                    ...
                    let streeng = days + "d " + hours + "h " + minutes + "m " + seconds + "s ";
                    

                    cnt[i].innerHTML = "<p>" + streeng + "</p>"
